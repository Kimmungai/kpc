...
@section('content')
		...
		<!-- /inner_content-->
	            ...
	            <div class="w3l_agileits_breadcrumbs_inner">
				 ...
				 <div class="inner_content_w3_agile_info">
						...
						<div class="row mt-2">
							...
							<div class="col-xs-6">
								<a href="#" class="btn btn-sm btn-default btn-block" title="Click to share document via email" onclick="share_report('/share-revenue-report')"><span class="fa fa-share-alt"></span> Share</a>
							</div>
							<div class="col-xs-6">
								<form id="download-form" class="hidden" action="/download-revenue-report" method="get">
            ...
            @component('components.revenue-report',['revenues'=>$revenues,'StartDate'=>$StartDate,'EndDate'=>$EndDate])@endcomponent
						<!--end purchase-show-->
