...
@section('content')
		...
		<!-- /inner_content-->
	            ...
	            <div class="w3l_agileits_breadcrumbs_inner">
	              <ul>
	                <li><a href="/home">Home</a> <span>«</span></li>
									<li><a href="/purchases-registration">Bookings report</a> </li>
	              </ul>
	            </div>
	          </div>
				 ...
				 <div class="inner_content_w3_agile_info">
					...
					<div class="container" >
						...
						<div class="row mt-2">
							...
							<div class="col-xs-6">
								<a href="#" class="btn btn-sm btn-default btn-block" title="Click to share document via email" onclick="share_report('/share-booking-report')"><span class="fa fa-share-alt"></span> Share</a>
							</div>
							<div class="col-xs-6">
								<form id="download-form" class="hidden" action="/download-booking-report" method="get">
						...
						<!--sorting-->
							<div class="row mt-2">
								<form class="" action="/booking-filtered-report" method="get">
								<div class="col-xs-2">
									<p style="line-height:40px">Sort:</p>
								</div>
								<div class="col-xs-3">
									<select class="duration_sort" id="duration_sort" class="form-control" name="duration_sort" onchange="set_report_duration(this.value)">
            ...
            @component('components.bookings-report',['bookings'=>$bookings,'StartDate'=>$StartDate,'EndDate'=>$EndDate])@endcomponent
						<!--end purchase-show-->
