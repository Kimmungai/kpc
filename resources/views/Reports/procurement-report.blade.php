	          ...
	          <div class="w3l_agileits_breadcrumbs">
	            <div class="w3l_agileits_breadcrumbs_inner">
				 ...
				 <div class="inner_content_w3_agile_info">
						...
						<!--sorting-->
							<div class="row mt-2">
								<form class="" action="/purchase-filtered-report" method="get">
								<div class="col-xs-2">
						...
						@endif
            @component('components.purchases-report',['purchases'=>$purchases,'StartDate'=>$StartDate,'EndDate'=>$EndDate])@endcomponent
						<!--end purchase-show-->
