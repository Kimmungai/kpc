...
<div class="form-group" id="paymentDueDateTitle">
  ...
  <div class="col-md-8">
    <div class="input-group input-icon right">
      ...
      <input name="paymentDueDate" id="paymentDueDate" type="text" class="form-control numeric" value="@if( old('paymentDueDate') ) {{old('paymentDueDate')}} @elseif( isset($expense) ) {{$expense->paymentDueDate}} @endif" placeholder="Enter digits only..." onblur="validate(this.id,{required:0,min:1},this.value)"/>
    </div>
  </div>
  <div class="col-sm-2">
